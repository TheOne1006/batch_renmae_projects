...
var baseUrlCreater = function (pageNum) {
  return 'http://www.ximalaya.com/49265909/album/7368509?page='+pageNum;
}
var totalPage = 3;
var basePage = 1;
var writeFilePathInfo = path.resolve(config.rootPath, 'baseRules','xxw.json');
...
getAllContent()
  ...
  .then(function (data) {
    ...
    var promiseFileName = getAllfileNames('/Users/theone/Downloads/完结 12.小学问/');
    ...
    Promise.mapSeries(dataArr, function(item) {
      return new Promise(function (resolve) {
        ...
        if (matchFile) {
          ...
          var targetFile = '/Users/theone/theone/resources_share/小学问/' + item.title + extname;
