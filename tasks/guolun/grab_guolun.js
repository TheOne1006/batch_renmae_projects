...
var baseUrlCreater = function (pageNum) {
  return 'http://www.ximalaya.com/91044493/album/11438153?page='+pageNum;
}
var totalPage = 1;
var basePage = 1;
var writeFilePathInfo = path.resolve(config.rootPath, 'baseRules','guolun.json');
...
getAllContent()
  ...
  .then(function (data) {
    ...
    var promiseFileName = getAllfileNames('/Users/theone/Downloads/01. 郭论：郭德纲脱口秀/');
    ...
    Promise.mapSeries(dataArr, function(item) {
      return new Promise(function (resolve) {
        ...
        if (matchFile) {
          ...
          var targetFile = '/Users/theone/theone/resources_share/郭论/' + item.title + extname;
